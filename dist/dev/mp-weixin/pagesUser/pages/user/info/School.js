...
if (!Array) {
  ...
  const _component_div = common_vendor.resolveComponent("div");
  Math.max.call(null, _easycom_uni_search_bar2, _easycom_uni_list_item2, _easycom_uni_list2, _component_div);
}
const _easycom_uni_search_bar = () => "../../../../uni_modules/uni-search-bar/components/uni-search-bar/uni-search-bar.js";
const _easycom_uni_list_item = () => "../../../../uni_modules/uni-list/components/uni-list-item/uni-list-item.js";
const _easycom_uni_list = () => "../../../../uni_modules/uni-list/components/uni-list/uni-list.js";
if (!Math) {
  Math.max.call(null, _easycom_uni_search_bar, _easycom_uni_list_item, _easycom_uni_list);
}
const __default__ = {
  name: "school"
};
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        b: common_vendor.o(($event) => common_vendor.isRef(schoolName) ? schoolName.value = $event : schoolName = $event),
        c: common_vendor.p({
          placeholder: "\u8BF7\u8F93\u5165\u5B66\u6821\u540D\u79F0",
        ...
        e: common_vendor.f(common_vendor.unref(schools), (item, k0, i0) => {
          return {
            a: item.code,
            b: common_vendor.o(($event) => onChecked(item)),
            c: "39ba6050-3-" + i0 + ",39ba6050-2",
            d: common_vendor.p({
              title: item.name,
              clickable: true
            })

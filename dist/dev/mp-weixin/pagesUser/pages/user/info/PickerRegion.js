  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        d: common_vendor.o$1(multiColumn),
        e: common_vendor.o$1(multiChange)
      };
    };
  }
});
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "C:/myself/social/social/src/pagesUser/pages/user/info/PickerRegion.vue"]]);

  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        h: common_vendor.o$1(($event) => common_vendor.unref(formData).motto = $event.detail.value),
        i: common_vendor.p({
          name: "motto"
        }),
        j: common_vendor.unref(formData).nickname,
        k: common_vendor.o$1(($event) => common_vendor.unref(formData).nickname = $event.detail.value),
        l: common_vendor.p({
          label: "\u6635\u79F0",
          name: "nickname"
        }),
        m: common_vendor.t(gender.value),
        n: common_vendor.o$1(changeGender),
        o: common_vendor.p({
          label: "\u6027\u522B",
          name: "gender"
        }),
        ...
        t: common_vendor.o$1(bindDateChange),
        v: common_vendor.p({
          label: "\u51FA\u751F\u65E5\u671F",
          name: "birthday"
        }),
        w: common_vendor.o$1(onChange),
        x: common_vendor.p({
        ...
        z: common_vendor.o$1(onChangeHome),
        A: common_vendor.p({
        ...
        D: common_vendor.o$1(openSchool),
        E: common_vendor.o$1(onChangeSchool),
        F: common_vendor.p({
          label: "\u5B66\u6821",
          name: "schoolName"
        }),
        ...
        J: common_vendor.o$1(changeProfession),
        K: common_vendor.p({
          label: "\u804C\u4E1A",
          name: "job"
        }),
        ...
        N: common_vendor.o$1(submit)
      };
    };
  }
};
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-4ff6606e"], ["__file", "C:/myself/social/social/src/pagesUser/pages/user/info/Editor.vue"]]);

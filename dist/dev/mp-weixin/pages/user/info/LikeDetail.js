...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    a: $setup.hobbyInfo.avatar || "",
    b: common_vendor.t($setup.hobbyInfo.username || ""),
    c: common_vendor.t($setup.followText),
    d: !$setup.isFlollow ? 1 : "",
    e: $setup.isFlollow ? 1 : "",
    f: common_vendor.o$1((...args) => $setup.following && $setup.following(...args)),
    g: $setup.hobbyInfo.fileType === 0
  }, $setup.hobbyInfo.fileType === 0 ? {
    h: $setup.hobbyInfo.url
  } : {}, {
    i: $setup.hobbyInfo.fileType === 1
  }, $setup.hobbyInfo.fileType === 1 ? {
    j: $setup.hobbyInfo.id,
    k: common_vendor.p({
      options: {
    ...
    l: common_vendor.t($setup.hobbyInfo.title),
    m: common_vendor.t($setup.hobbyInfo.content),
    n: common_vendor.t($setup.publishDate),
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-6e1530a9"], ["__file", "C:/myself/social/social/src/pages/user/info/LikeDetail.vue"]]);

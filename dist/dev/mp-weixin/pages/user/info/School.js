...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  setup(__props) {
    ...
    const onChecked = (item) => {
      ...
      schools.value = [];
      common_vendor.index.$emit("schoolUpdate", { schoolName: schoolName.value });
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "C:/myself/social/social/src/pages/user/info/School.vue"]]);
